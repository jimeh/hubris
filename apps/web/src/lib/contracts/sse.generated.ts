...
export type ExperimentalSettings = { chatEnabled: boolean };
...
export type EventKind =
  | {
      ...
      data: {
        ...
        chatAppServer: ChatAppServerStatus;
        chatConversations: Array<ChatConversationSummary>;
        chatPendingRequests: Array<ChatPendingRequestSummary>;
        chatContextUsage: Array<ChatContextUsage>;
        chatReconciliations: Array<ChatReconciliation>;
        chatRuntimes: Array<ChatRuntimeStatus>;
        chatThreadStreams: Array<ChatThreadStreamStatus>;
        projects: Array<Project>;
        worktrees: { [key in string]: Array<Worktree> };
        projectErrors: { [key in string]: string };
        settings: Settings;
        settingsGeneration: string;
        settingsStatus: SettingsStatus;
        keybindings: Array<KeybindingEntry>;
        keybindingsGeneration: string;
        keybindingsStatus: KeybindingsStatus;
        vscode: VscodeStatus;
        managedProcesses: Array<ManagedProcessStatus>;
  ...
  | { type: "tab_created"; data: { sessionId: string; tab: TabInfo } }
  | { type: "tab_closed"; data: { sessionId: string; tabId: string } }
  | { type: "tab_updated"; data: { sessionId: string; tab: TabInfo } }
  | {
      type: "tabs_reordered";
      data: { sessionId: string; worktreeId: string; tabs: Array<TabInfo> };
    }
  | {
      type: "worktree_tab_layout_updated";
      data: { worktreeId: string; state: WorktreeTabLayoutState };
    }
  | { type: "project_added"; data: Project }
  | { type: "project_removed"; data: { projectId: string } }
  ...
  | {
      ...
      data: { projectId: string; worktreeId: string };
    }
  | {
      type: "worktrees_reordered";
      data: { projectId: string; worktrees: Array<Worktree> };
    }
  | {
  ...
  | {
      ...
      data: {
        ...
        listingPaths: Array<string>;
      };
    }
  | {
      type: "worktree_git_status_updated";
      data: { projectId: string; worktreeId: string; generation: number };
    }
  ...
  | {
      ...
      data: { sessionId: string; conversation: ChatConversationSummary };
    }
  | {
  ...
  | {
      ...
      data: { sessionId: string; runtime: ChatRuntimeStatus };
    }
  | {
      type: "chat_app_server_updated";
      data: { appServer: ChatAppServerStatus };
    }
  | {
      type: "chat_thread_stream_updated";
      data: { sessionId: string; stream: ChatThreadStreamStatus };
    }
  | {
  ...
  | {
      ...
      data: { sessionId: string; conversationId: string; message: ChatMessage };
    }
  | {
      type: "chat_run_updated";
      data: { sessionId: string; conversationId: string; run: ChatRun };
    }
  | {
      type: "chat_turn_updated";
      data: { sessionId: string; conversationId: string; turn: ChatTurn };
    }
  | {
      type: "chat_item_updated";
      data: { sessionId: string; conversationId: string; item: ChatItem };
    }
  | {
  ...
  | {
      ...
      data: { sessionId: string; request: ChatPendingRequest };
    }
  | {
  ...
  | {
      ...
      data: { sessionId: string; conversationId: string; plan: ChatPlan };
    }
  | {
  ...
  | {
      ...
      data: { sessionId: string; usage: ChatContextUsage };
    }
  | {
      type: "chat_reconciliation_started";
      data: { sessionId: string; reconciliation: ChatReconciliation };
    }
  | {
